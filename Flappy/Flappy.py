...
class Bird:
    ...
    def draw(self,win):
        ...
        rotatwd_image = pygame.transform.rotate(self.img,self.tilt)
        new_rec = rotatwd_image.get_rect(center = self.img.get_rect(topleft = (self.x,self.y)).center)
        win.blit(rotatwd_image,new_rec.topleft)
    def get_mask(self):
